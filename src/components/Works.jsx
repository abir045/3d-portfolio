  ...
  <motion.div variants={slideIn("right", "tween", 0.1, 0.5)} className="h-full">
    ...
    >
      ...
      <div className="flex items-center justify-center space-x-5 my-5">
        ...
        >
          <img src={github} alt="github" className="w-[50px] object-contain" />
        </div>
        ...
        >
          <img src={live} alt="live url" className="w-[50px]  object-contain" />
        </div>
      </div>
    </Tilt>
  </motion.div>
  ...
  return (
    <>
      ...
      <motion.p
        ...
        className="text-primary text-[17px] max-w-3xl mb-5"
      >
        Following are some of my featured projects. Each project is briefly
